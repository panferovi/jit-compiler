...
public:
    ArithmInst(BasicBlock *ownBB, InstId id, Opcode op, ResultType resType, InstProxyList inputs) : Instruction(ownBB, id, op, resType, inputs)
    {
        ASSERT(resType != ResultType::VOID);
...
public:
    BranchInst(BasicBlock *ownBB, InstId id, Opcode op, InstProxyList inputs) : Instruction(ownBB, id, op, ResultType::VOID, inputs)
    {
...
public:
    ReturnInst(BasicBlock *ownBB, InstId id, Opcode op, ResultType resType, InstProxyList inputs) : Instruction(ownBB, id, op, resType, inputs)
    {
